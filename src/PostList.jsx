    ...
    <div className="container">
      ...
      {filteredBlogs.map(blog => (
        <div className="post-wrapper" key={blog.id}>
          ...
          <img src={blog.rating >= 1 ? 'src/assets/icons8-star-50(1).png' : '/assets/icons8-star-50.png'} alt="star" className="star" />

            <img src={blog.rating >= 2 ? 'src/assets/icons8-star-50(1).png' : 'src/assets/icons8-star-50.png'} alt="star" className="star" />
            <img src={blog.rating >= 3 ?'src/assets/icons8-star-50(1).png' : 'src/assets/icons8-star-50.png'} alt="star" className="star" />
            <img src={blog.rating >= 4 ? 'src/assets/icons8-star-50(1).png' : 'src/assets/icons8-star-50.png'} alt="star" className="star" />
            <img src={blog.rating == 5 ? 'src/assets/icons8-star-50(1).png' : 'src/assets/icons8-star-50.png'} alt="star" className="star" />
          </div>
