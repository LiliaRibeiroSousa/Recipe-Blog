      ...
      {filteredBlogs.map(blog => (
        <div className="post-wrapper" key={blog.id}>
          ...
          <div className="recipeRating">
            <img src={blog.rating >= 1 ? '/assets/icons8-star-50(1).png' : '/assets/icons8-star-50.png'} alt="star" className="star" />
            ...
            <img src={blog.rating == 5 ? 'src/icons/icons8-star-50(1).png' : 'src/icons/icons8-star-50.png'} alt="star" className="star" />
          </div>
